...
<div style="display:grid; grid-template-columns: 150px 150px 300px 75px; grid-template-rows: 60px 120px 30px 30px 30px 60px 120px 120px 60px 30px 60px 60px 60px;">
    ...
    <a href="https://stratigraphy.org/subcommission-cretaceous/gssp/campanian" style="grid-column:3; grid-row:2; background-color:#EBEC9E;" class="age gssp">Campanian</a><div style="grid-column:4; grid-row:2;" class="num">72.1</div>
