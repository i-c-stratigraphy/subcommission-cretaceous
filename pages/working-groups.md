...
<div style="display:grid; grid-template-columns: 150px 150px 300px 40px 50px; grid-template-rows: 67px 125px 22px 40px 49px 72px 138px 89px 56px 66px 56px 59px;">
    ...
    <a href="https://stratigraphy.org/subcommission-cretaceous/wgs/campanian" style="grid-column:3; grid-row:2; background-color:#EBEC9E;" class="age gssp">Campanian</a><div style="grid-column:4; grid-row:2;" class="num">72.17</div>
