...
<div style="display:grid; grid-template-columns: 150px 150px 300px 40px 50px; grid-template-rows: 67px 125px 22px 40px 49px 72px 138px 89px 56px 66px 56px 59px;">
    ...
    <a href="https://stratigraphy.org/subcommission-cretaceous/gssps/barremian" style="grid-column:3; grid-row:9; background-color:#B4DE9F;" class="age wg">Barremian</a><div style="grid-column:4; grid-row:9;" class="num">121.4</div>
