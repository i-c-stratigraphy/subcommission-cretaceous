...
<div style="display:grid; grid-template-columns: 150px 150px 300px 40px 50px; grid-template-rows: 67px 125px 22px 40px 49px 72px 138px 89px 56px 66px 56px 59px;">
    ...
    <a href="https://stratigraphy.org/subcommission-cretaceous/wgs/coniacian" style="grid-column:3; grid-row:4; background-color:#D2E38C;" class="age gssp">Coniacian</a><div style="grid-column:4; grid-row:4;" class="num">85.7</div>
